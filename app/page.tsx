...
const TEAS = [
  ...
  { id: "caramel-brownie-breakfast", name: "Caramel Brownie Breakfast", image: "/images/caramel-brownie.jpg",  color: "#7B4A1E", t2url: "https://www.t2tea.com/search?q=caramel+brownie+breakfast",  description: "Indulgent and warming, this dessert-inspired breakfast blend wraps rich caramel sweetness around a dark, chocolatey base. Like a fresh-baked brownie in a cup — deeply satisfying any time of day." },
  { id: "lamington-breakfast",       name: "Lamington Breakfast",       image: "/images/lamington.jpg",        color: "#B04080", t2url: "https://www.t2tea.com/search?q=lamington+breakfast+tea",  description: "A true Aussie icon in tea form. Light and sweet with notes of coconut and chocolate, this breakfast blend captures the spirit of the classic sponge cake. Delicate, fun and unmistakably Australian." },
];
...
const TEA_INGREDIENT_MAP: Record<string, string[]> = {
  ...
  "caramel-brownie-breakfast": ["cacao-husk", "vanilla", "oat-flakes"],
  "lamington-breakfast":       ["coconut", "cacao-husk", "rose-petals"],
};
